package com.github.edwincheng.advancelightdemo.chap_one.utils;
...
/**
 * @ file name:    : NotifycationPermissionUtil
 * @ author        : edwincheng
 * @ e-mail        : zwp_edwincheng@163.com
 * @ date          : 20-2-28 15:13
 * @ description   : 通知权限检测工具
 * @ modify author :
 * @ modify date   :
 */
public class NotifycationPermissionUtil {
    //判断是否需要打开设置界面
